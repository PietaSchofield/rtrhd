...
- Copy them from CPRDGeneralinfo drive to a University asset you have read/write access to
   ...
   - __do not copy to unencrypted non_password protected devices (eg. penstick, pers laptops)__
...
dbcon <- DBI::dbConnect(duckdb::duckdb(shared_home=FALSE),dbname,read_only=T)
# build the query
...
# Thank You </br>pietas@uol.ac.uk</br>[https://github.com/PietaSchofield](https://github.com/PietaSchofield)
...
rmarkdown::render(
 input=file.path(Sys.getenv("HOME"),"repositories","github","rtrhd","index.Rmd"),
 output_file=outfile
 )
```
